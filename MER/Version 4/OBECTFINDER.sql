...
-- Created by julio.bolanos on 02/03/2016, 17:00:06 --
------------------------------------------------------
...
alter table ADMIN.OBJETO
  add constraint ID_ESTADO_OBJ_FK foreign key (ID_ESTADO)
...
prompt
prompt Creating sequence ID_CATEGO_SEQ
prompt ===============================
prompt
create sequence ADMIN.ID_CATEGO_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_DEPTO_SEQ
prompt ==============================
prompt
create sequence ADMIN.ID_DEPTO_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_ESTADO_SEQ
prompt ===============================
prompt
create sequence ADMIN.ID_ESTADO_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_INTEGRA_SEQ
prompt ================================
prompt
create sequence ADMIN.ID_INTEGRA_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt ==================================
prompt
create sequence ADMIN.ID_LOCALIDAD_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_MEDIA_SEQ
prompt ==============================
prompt
create sequence ADMIN.ID_MEDIA_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_MUNICIPIO_SEQ
prompt ==================================
prompt
create sequence ADMIN.ID_MUNICIPIO_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_NOTIF_SEQ
prompt ==============================
prompt
create sequence ADMIN.ID_NOTIF_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_OBJETO_SEQ
prompt ===============================
prompt
create sequence ADMIN.ID_OBJETO_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_PERFIL_SEQ
prompt ===============================
prompt
create sequence ADMIN.ID_PERFIL_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_PER_USU_SEQ
prompt ================================
prompt
create sequence ADMIN.ID_PER_USU_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_PROC_REG_SEQ
prompt =================================
prompt
create sequence ADMIN.ID_PROC_REG_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_REGISTRO_SEQ
prompt =================================
prompt
create sequence ADMIN.ID_REGISTRO_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
...
prompt
prompt Creating sequence ID_USUARIO_SEQ
prompt ================================
prompt
create sequence ADMIN.ID_USUARIO_SEQ
minvalue 1
maxvalue 2147483647
start with 1
increment by 1
